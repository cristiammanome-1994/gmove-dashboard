  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        status: {
          met: "hsl(var(--status-met))",
          "met-foreground": "hsl(var(--status-met-foreground))",
          near: "hsl(var(--status-near))",
          "near-foreground": "hsl(var(--status-near-foreground))",
          ...
          video: "hsl(var(--status-video))",
          "video-foreground": "hsl(var(--status-video-foreground))",
        },
        priority: {
          high: "hsl(var(--priority-high))",
          mid: "hsl(var(--priority-mid))",
